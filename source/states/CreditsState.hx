	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
		  ['Imperfect Team'],
			...
			['chill_ultimated', 'chill_ultimated', 'Charter and Programmer', 'https://youtube.com/@chill_ultimated?si=MtTL9vBWA2Ujb5x1', '57C057'],
			['Hazzy', 'hazzy', 'Programmer', 'https://youtube.com/@hazzy83?si=UaLHyj7brYhQmH4N', '716DB9'],
			['MaysLastPlay', 'mayslastplay', 'Programmer', 'https://youtube.com/@mayslastplay?si=96N5Fndao0kQQo7k', '9896C9'],
